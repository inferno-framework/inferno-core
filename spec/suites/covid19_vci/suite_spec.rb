RSpec.describe Covid19VCI::Suite do
  ...
  describe 'vci-file-download group' do
    describe 'vci-file-01' do
      let(:test) { suite.groups.first.tests.first }
    ...
    describe 'vci-file-02' do
      let(:test) { suite.groups.first.tests[1] }
    ...
    describe 'vci-file-03' do
      let(:test) { suite.groups.first.tests[2] }
    ...
    describe 'vci-file-04' do
      let(:test) { suite.groups.first.tests[3] }
