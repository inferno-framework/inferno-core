    ...
    { title: 'Preset for Demonstration Suite',
      ...
      inputs: [
        ...
        { name: 'single_checkbox',
          _type: 'checkbox',
          _title: 'Checkbox Single Input Example',
          _description: 'Checkbox description',
          _optional: false,
          _options: { list_options: [{ label: 'Check this box', value: 'checked'}] },
          value: ['checked'] },
        { name: 'single_locked_checkbox',
          _type: 'checkbox',
          _title: 'Checkbox Single Locked Input Example',
          _description: 'Checkbox description',
          _optional: false,
          _options: { list_options: [{ label: 'Check this box', value: 'checked'}] },
          value: ['checked'] },
