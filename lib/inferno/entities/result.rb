module Inferno
  module Entities
    ...
    # @attr_accessor [String] reference_type type of entity this result belongs to
    #   (`Test`, `TestGroup`, or `TestSuite`)
    # @attr_accessor [String, nil] test_id id of the `Test` this result belongs to
    # @attr_accessor [Test, nil] test the `Test` this result belongs to
    # @attr_accessor [String, nil] test_group_id id of the `TestGroup` this result belongs to
    # @attr_accessor [TestGroup, nil] test_group the `TestGroup` this result belongs to
    # @attr_accessor [String, nil] test_suite_id id of the `TestSuite` this result belongs to
    # @attr_accessor [TestSuite, nil] test_suite the `TestSuite` this result belongs to
