module ONCProgram
  class USCorePediatricWeightForHeight < Inferno::TestGroup
    title 'PediatricWeightForHeight Tests'
    description <<~DESCRIPTION
      # Background

      The US Core #{title} sequence verifies that the system under test is able to provide correct responses
      for PediatricWeightForHeight queries.  These queries must contain resources conforming to US Core PediatricWeightForHeight Profile as specified
    ...
    id :us_core_pediatric_weight_for_height
    ...
    test do
      title 'Patient resources returned from previous search conform to the US Core Patient Profile.'
      description <<~DESCRIPTION
