module ONCProgram
  class USCoreMedicationRequest < Inferno::TestGroup
    ...
    test do
      ...
      description <<~DESCRIPTION
        A server SHALL support searching by _id on the MedicationRequest resource.
    ...
    test do
      ...
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the MedicationRequest resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for MedicationRequest search by name.'
      description <<~DESCRIPTION
        A server SHALL support searching by name on the MedicationRequest resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for MedicationRequest search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the MedicationRequest resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for MedicationRequest search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the MedicationRequest resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'MedicationRequest resources returned from previous search conform to the US Core MedicationRequest Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * MedicationRequest.extension:birthsex
        * MedicationRequest.extension:ethnicity
        * MedicationRequest.extension:race
        * address
        * address.city
        * address.line
        * address.period
