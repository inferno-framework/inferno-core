module ONCProgram
  class USCoreGoal < Inferno::TestGroup
    title 'Goal Tests'
    ...
    test do
      title 'Server returns Provenance resources from Goal search by patient + _revIncludes: Provenance:target'
      description <<~DESCRIPTION
    ...
    test do
      title 'Goal resources returned from previous search conform to the US Core Goal Profile.'
      description <<~DESCRIPTION
