module ONCProgram
  class USCoreEncounter < Inferno::TestGroup
    ...
    test do
      ...
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the Encounter resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Encounter search by name.'
      description <<~DESCRIPTION
        A server SHALL support searching by name on the Encounter resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Encounter search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the Encounter resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Encounter search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the Encounter resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Encounter resources returned from previous search conform to the US Core Encounter Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * Encounter.extension:birthsex
        * Encounter.extension:ethnicity
        * Encounter.extension:race
        * address
        * address.city
        * address.line
        * address.period
