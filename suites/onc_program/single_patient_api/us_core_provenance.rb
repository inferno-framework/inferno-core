module ONCProgram
  class USCoreProvenance < Inferno::TestGroup
    ...
    id :us_core_provenance

    input :url, :token, :patient_ids

    test do
      title 'Server returns valid results for Provenance search by _id.'
      description <<~DESCRIPTION
        A server SHALL support searching by _id on the Provenance resource.
    ...
    test do
      title 'Server returns valid results for Provenance search by identifier.'
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the Provenance resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Provenance search by name.'
      description <<~DESCRIPTION
        A server SHALL support searching by name on the Provenance resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Provenance search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the Provenance resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Provenance search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the Provenance resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Provenance resources returned from previous search conform to the US Core Provenance Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * Provenance.extension:birthsex
        * Provenance.extension:ethnicity
        * Provenance.extension:race
        * address
        * address.city
        * address.line
        * address.period
