module ONCProgram
  class USCoreImmunization < Inferno::TestGroup
    ...
    id :us_core_immunization

    input :url, :token, :patient_ids

    test do
      title 'Server returns valid results for Immunization search by _id.'
      description <<~DESCRIPTION
        A server SHALL support searching by _id on the Immunization resource.
    ...
    test do
      title 'Server returns valid results for Immunization search by identifier.'
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the Immunization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Immunization search by name.'
      description <<~DESCRIPTION
        A server SHALL support searching by name on the Immunization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Immunization search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the Immunization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Immunization search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the Immunization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Immunization resources returned from previous search conform to the US Core Immunization Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * Immunization.extension:birthsex
        * Immunization.extension:ethnicity
        * Immunization.extension:race
        * address
        * address.city
        * address.line
        * address.period
