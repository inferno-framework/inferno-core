module ONCProgram
  class USCoreProcedure < Inferno::TestGroup
    ...
    id :us_core_procedure

    input :url, :token, :patient_ids

    test do
      title 'Server returns valid results for Procedure search by _id.'
      description <<~DESCRIPTION
        A server SHALL support searching by _id on the Procedure resource.
    ...
    test do
      title 'Server returns valid results for Procedure search by identifier.'
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the Procedure resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Procedure search by name.'
      description <<~DESCRIPTION
        A server SHALL support searching by name on the Procedure resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Procedure search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the Procedure resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Procedure search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the Procedure resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Procedure resources returned from previous search conform to the US Core Procedure Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * Procedure.extension:birthsex
        * Procedure.extension:ethnicity
        * Procedure.extension:race
        * address
        * address.city
        * address.line
        * address.period
