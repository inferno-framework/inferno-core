module ONCProgram
  class USCoreImplantableDevice < Inferno::TestGroup
    ...
    id :us_core_implantable_device

    input :url, :token, :patient_ids, :device_codes
    ...
    test do
      title 'Server returns Provenance resources from Device search by patient + _revIncludes: Provenance:target'
      description <<~DESCRIPTION
    ...
    test do
      title 'Device resources returned from previous search conform to the US Core Implantable Device Profile.'
      description <<~DESCRIPTION
