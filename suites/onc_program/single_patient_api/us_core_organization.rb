module ONCProgram
  class USCoreOrganization < Inferno::TestGroup
    ...
    test do
      ...
      description <<~DESCRIPTION
        A server SHALL support searching by _id on the Organization resource.
    ...
    test do
      title 'Server returns valid results for Organization search by identifier.'
      description <<~DESCRIPTION
        A server SHALL support searching by identifier on the Organization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Organization search by birthdate+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by birthdate+name on the Organization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Server returns valid results for Organization search by gender+name.'
      description <<~DESCRIPTION
        A server SHALL support searching by gender+name on the Organization resource.
        This test will pass if resources are returned and match the search criteria. If none are returned, the test is skipped.
      DESCRIPTION
      # link 'https://www.hl7.org/fhir/us/core/CapabilityStatement-us-core-server.html'
    ...
    test do
      title 'Organization resources returned from previous search conform to the US Core Organization Profile.'
      description <<~DESCRIPTION
    ...
    test do
      ...
      description <<~DESCRIPTION
        ...
        * Organization.extension:birthsex
        * Organization.extension:ethnicity
        * Organization.extension:race
        * address
        * address.city
        * address.line
        * address.period
