module ONCProgram
  class USCoreCareTeam < Inferno::TestGroup
    ...
    test do
      title 'CareTeam resources returned from previous search conform to the US Core CareTeam Profile.'
      description <<~DESCRIPTION
    ...
    test do
      title 'The server returns results when parameters use composite-or'
      description <<~DESCRIPTION
