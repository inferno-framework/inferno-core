module ONCProgram
  class StandaloneTokenRefresh < Inferno::TestGroup
    title 'Token Refresh'
    ...
    id :standalone_token_refresh

    input :onc_sl_url, :onc_sl_client_id, :onc_sl_confidential_client, :onc_sl_client_secret, :refresh_token,
          :oauth_token_endpoint
    output :token, :refresh_token, :onc_sl_token, :onc_sl_refresh_token, :onc_sl_patient_id,
