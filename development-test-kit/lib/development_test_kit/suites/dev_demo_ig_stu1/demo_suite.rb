...
module DevelopmentTestKit
  class DemoSuite < Inferno::TestSuite
    ...
    group do
      id :simple_group
      title 'Group 1'
      group from: 'DevelopmentTestKit::DemoGroup', title: 'Demo Group Instance 1'
    end
    ...
    group do
      ...
      title 'Group 2'
      group from: 'DevelopmentTestKit::DemoGroup', id: 'DEF', title: 'Demo Group Instance 2'
      group from: 'DevelopmentTestKit::DemoGroup' do
        id 'GHI'
