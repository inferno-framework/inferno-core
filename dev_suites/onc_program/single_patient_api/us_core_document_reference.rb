module ONCProgram
  class USCoreDocumentReference < Inferno::TestGroup
    ...
    test do
      title 'Server returns Provenance resources from DocumentReference search by patient + _revIncludes: Provenance:target'
      description <<~DESCRIPTION
    ...
    test do
      title 'DocumentReference resources returned from previous search conform to the US Core DocumentReference Profile.'
      description <<~DESCRIPTION
