module ONCProgram
  class USCoreDiagnosticReportNote < Inferno::TestGroup
    ...
    id :us_core_diagnostic_report_note
    ...
    test do
      title 'DiagnosticReport resources returned from previous search conform to the US Core DiagnosticReport Profile for Report and Note exchange.'
      description <<~DESCRIPTION
