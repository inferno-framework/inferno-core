...
- **[SMART Application Launch Framework Test Kit](https://github.com/inferno-framework/smart-app-launch-test-kit)**: Tests for the [SMART Application Launch Framework](http://hl7.org/fhir/smart-app-launch/index.html)
